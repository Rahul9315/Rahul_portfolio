        ...
        >
          <Box p={{ base: "0", sm: "25px" }}>
            ...
            <Box w="10%">
                <a
                  target="_blank"
                  href="mailto: baghel931515@gmail.com"
                >
                  <motion.div
                    whileHover={{ scale: 1.1 }}
                    whileTap={{ scale: 0.9 }}
              ...
              <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
                <a target="_blank" href="mailto: baghel931515@gmail.com">
                  <Text
                    fontSize="sm"
                    color="#00796B"
                    fontWeight="500"
            ...
            <Flex mt="25px">
              <Box w="10%">
                <a
                  target="_blank"
                  href="https://www.linkedin.com/in/rahul-baghel-9a52a925b/"
                >
                  <motion.div
                    whileHover={{ scale: 1.1 }}
                    whileTap={{ scale: 0.9 }}
            ...
            <Flex mt="25px">
              <Box w="10%">
                <a target="_blank" href="https://github.com/Rahul9315">
                  <motion.div
                    whileHover={{ scale: 1.1 }}
                    whileTap={{ scale: 0.9 }}
                    style={{ width: "10%" }}
